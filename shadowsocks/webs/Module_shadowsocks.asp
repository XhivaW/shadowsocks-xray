...
var option_vorx = [["v2ray","v2ray"],["xray","xray"]]
...
function verifyFields(r) {
	...
	elem.display(elem.parentElem('ss_basic_v2ray_xray', 'tr'), v2ray_on);
...
function Add_profile() { //点击节点页面内添加节点动作
	...
	E("ss_node_table_v2ray_xray").value = "";
...
function add_ss_node_conf(flag) {
	...
	var params4_1 = ["v2ray_xray", "mode", "name", "server", "port", "v2ray_uuid", "v2ray_alterid", "v2ray_security", "v2ray_network", "v2ray_headtype_tcp", "v2ray_headtype_kcp", "v2ray_network_path", "v2ray_network_host", "v2ray_network_security", "v2ray_mux_concurrency"]; //for v2ray
														...
														<table id="table_edit" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable">
															<script type="text/javascript">
																$('#table_edit').forms([
																	...
																	{ title: 'VorX', rid:'v2ray_xray_tr', id:'ss_node_table_v2ray_xray', type:'select', func:'v', options:option_vorx, style:'width:350px', value:"v2ray"},
											...
											<table id="table_basic" width="100%" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
												<script type="text/javascript">
													$('#table_basic').forms([
														...
														{ title: 'VorX', id:'ss_basic_v2ray_xray', type:'select', func:'v', options:option_vorx, value:"v2ray"},
